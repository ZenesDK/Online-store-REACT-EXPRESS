...
- Настроена базовая конфигурация Swagger
- Описана схема `Product` и `ProductInput`
- Добавлены JSDoc комментарии для всех 5 эндпоинтов
...
### 1️⃣ Запуск бэкенда с Swagger
```bash
cd backend
npm install          # установка зависимостей
npm run dev          # запуск сервера с авто‑перезагрузкой (nodemon)
```
# Документация будет на http://localhost:3000/api-docs
